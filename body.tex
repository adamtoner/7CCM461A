...
\begin{equation}
    n\cdot P_{\lambda}(\Beta)=n\sum_{j=1}^q\Big(\lambda^2 - (|\beta_j|-\lambda)^2I(|\beta_j|<\lambda)\Big).
\end{equation}
...
\begin{equation}
    n\cdot P_\lambda'(\Beta) = n\sum_{j=1}^q\Big(I(|\beta_j|\leq\lambda)+\frac{(a\lambda-|\beta_j|)_{+}}{(a-1)\lambda}I(|\beta_j|>\lambda)\Big).
\end{equation}
